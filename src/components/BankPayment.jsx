                      ...
                      <div className="col-lg-7 col-md-12">
                        ...
                        <div className="transfer-detail">
                          ...
                          <div className="account">
                            <p className="account-number">{x.rek}</p>
                            <button
                              onClick={() => {
                            ...
                            <button
                              onClick={() => {
                                navigator.clipboard.writeText(
                                  document.querySelector(".price-to-pay")
                                    .textContent
                                );
                              }}
                            >
                          ...
                          <div className="content-tabs">
                            ...
                            >
                              <ul>
                                ...
                                <li>
                                  ...
                                  “Ke Rek {x.name} Virtual Account”
                                </li>
                                <li>
                                  Masukkan nomor {x.name} Virtual Account:
                                  70020+Order ID
                                  <br />
                                  Contoh:
                                  <br />
                                ...
                                <li>
                                  Layar ATM akan menampilkan konfirmasi, ikuti
                            ...
                            >
                              <ul>
                                ...
                                <li>
                                  Lorem ipsum dolor sit amet consectetur
                                  adipisicing elit. Sit, reprehenderit.
                                </li>
                                <li>
                                  Lorem ipsum dolor sit amet consectetur
                                  adipisicing elit. Mollitia, totam?
                                </li>
                              </ul>
                            </div>
                          </div>
                        ...
                        <div className="confirm-payment">
                          {confirm === "confirm" ? (
                            <div className="confirm-click">
                              <h5>
                                Klik konfirmasi pembayaran untuk mempercepat
                                proses pengecekan
                              </h5>
                              <button
